...
/**
 * Created by Maria on 17.09.2017.
 */

public class FrontBackCamera extends SurfaceView implements
...
//    public Camera mCamera;
    ...
    public FrontBackCamera(Context context, Camera camera, int cameraId) {
        super(context);
//        this.mCamera = camera;
